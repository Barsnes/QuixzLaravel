...
@section('title', 'Statutes DE')

@section('content')

  <div class="policy">

<h1>Statuten des Vereins Quixz esports </h1>
<h2>§ 1: Name, Sitz und Tätigkeitsbereich</h2>
<p>(1) Der Verein führt den Namen “Quixz esports”. (2) Er hat seinen Sitz in Dornbirn, Österreich. (3) Sein Tätigkeitsbereich erstreckt sich auf ganz Europa. (4) Die Errichtung von Zweigvereinen ist nicht beabsichtigt. </p>
<h2>§ 2: Zweck </h2>
<p>(1) Der Verein bezweckt der Förderung des Esports, sowie die Teilnahme an Esport-Wettbewerben. Er fördert seine Mitglieder im Bezug auf den Wettkampf in Videospielen und eröffnet einen Ort der Zusammenkunft für Interessierte jeden Alters. (2) Seine Tätigkeit ist nicht auf wirtschaftlichen Gewinn ausgerichtet.</p>
<h2>§ 3: Mittel zur Erreichung des Vereinszwecks</h2>
<p>(1) 1Der Verein strebt zu jeder Zeit seines Bestehens die Erreichung seines Vereinszwecks an. 2Dieses Streben wird nur durch die Einleitung einer Auflösung des Vereins unterbrochen. (2) Sein Vereinszweck soll durch die in Abs. 3 und 4 angeführten ideellen und materiellen Mittel
erreicht werden. (3) Als ideelle Mittel dienen
(a) Öffentlichkeitsarbeit (b) Organisation von spielerischen Anlässen (c) Bereitstellung von notwendiger Infrastruktur (4) Die erforderlichen materiellen Mittel sollen aufgebracht werden durch
(a) Spenden (b) Sponsoren (c) Mitgliedsbeiträge (d) private und öffentlichen Subventionen (e) Verkauf von Werbematerial und Fanartikel (f) Einnahmen von Veranstaltungen und Wettbewerben</p>
<h2>§ 4: Arten der Mitgliedschaft</h2>
<p>(1) Die Mitglieder des Vereins gliedern sich in einfache Mitglieder, qualifizierte Mitglieder und
Ehrenmitglied. (2) Einfache Mitglieder des Vereins sind jene, die seine Statuten, Ordnung und Organisation
...
und einfache Mitglieder, sowie Grund des Anfallens der Gebühren; (g) Verleihung und Aberkennung der Ehrenmitgliedschaft; (h) Beschlussfassung über Statutenänderungen und die freiwillige Auflösung des
Vereins; (i) Beratung und Beschlussfassung über sonstige auf der Tagesordnung stehende
Fragen.</p>
<h2>§ 11: Der Vorstand</h2>
<p>(1) Der Vorstand besteht aus dem Vereinsvorsitzenden und Stellvertreter, Schriftführer sowie
Kassier. (2) 1Der Vorstand wird von der Mitgliederversammlung gewählt. 2Er hat bei Ausscheiden eines gewählten Mitgliedes das Recht, an seiner Stelle ein anderes wählbares Mitglied zu kooptieren, wozu die Genehmigung in der nächstfolgenden Mitgliederversammlung einzuholen ist. 3Fällt der Vorstand ohne Selbstergänzung durch Kooptierung überhaupt oder auf unvorhersehbar lange Zeit aus, so ist jeder Rechnungsprüfer verpflichtet, unverzüglich eine außerordentliche Mitgliederversammlung zum Zweck der Neuwahl eines Vorstandes einzuberufen. 4Sollten auch die Rechnungsprüfer handlungsunfähig sein, hat jedes qualifizierte Mitglied, das die Notsituation erkennt, unverzüglich die Bestellung eines Kurators beim zuständigen Gericht zu beantragen. 5Dieser hat umgehend eine außerordentliche Mitgliederversammlung einzuberufen. (3) 1Die Funktionsperiode beträgt fünf Jahre. 2Eine Wiederwahl ist möglich. 3Jede Funktion im
Vorstand ist persönlich auszuüben. (4) 1Der Vorstand wird vom Vereinsvorsitzenden, bei Verhinderung von seinem Stellvertreter schriftlich oder mündlich einberufen. 2Ist auch dieser auf unvorhersehbar lange Zeit verhindert, darf jedes sonstige Vorstandsmitglied den Vorstand einberufen.
(5) Der Vorstand ist beschlussfähig, wenn alle seine Mitglieder eingeladen wurden und
mindestens die Hälfte von ihnen anwesend ist. (6) 1Der Vorstand fasst seine Beschlüsse mit einfacher Stimmenmehrheit. 2Bei
